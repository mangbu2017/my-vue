...
export default class Index extends Vue {
    ...
    handleCreateSuccess(payload) {
        ...
        const regUrl = `/spray-alga/detail/${this.$route.params.id}/database`;
    ...
    handlePageChange(page) {
        ...
        this.$router.push(`/spray-alga/detail/${this.$route.params.id}/database/${page}/${this.keyword}`);
    }
    ...
    handleSearch() {
        this.$router.push(`/spray-alga/detail/${this.$route.params.id}/database/1/${this.keyword}`);
    }
    ...
    fetchDatabaseListByPage(preventLoadingTip = false) {
        ...
        request({
            url: '/mysqlclientBack/mysqldbmgr/searchMysqlDbList',
            params: payload,
        }).then((data) => {
            this.loading = false;
    ...
    deleteDatabaseList(payload) {
        request({
            method: 'POST',
            url: '/mysqlclientBack/mysqldbmgr/deleteMysqlDb',
            headers: {
    ...
    submitAuthData(payload) {
        ...
        request({
            method: 'POST',
            url: '/mysqlclientBack/mysqldbmgr/modifyAuthority',
            data: qs.stringify({
                instanceID: this.$route.params.id,
    ...
    fetchUserList(payload) {
        request({
            url: '/mysqlclientBack/mysqldbmgr/searchAccountList',
            params: {
                instanceID: this.$route.params.id,
