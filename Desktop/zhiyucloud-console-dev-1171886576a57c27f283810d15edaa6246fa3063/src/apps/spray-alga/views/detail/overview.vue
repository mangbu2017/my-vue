    ...
    <div>
        ...
        <div v-if="instance" class="message-item">
            ...
            <table class="tai-table tai-table-border">
                ...
                <tr>
                    <td>内网地址</td>
                    <td>{{ instance.internNet }}</td>
                    <td>内网端口</td>
                    <td>{{ instance.internPort }}</td>
                </tr>
                <tr>
                    <td>集群地址1</td>
                    <td>{{ instance.cluster1 }}</td>
                    <td v-if="instance.cluster2">集群地址2</td>
                    <td v-if="instance.cluster2">{{ instance.cluster2 }}</td>
                </tr>
            </table>
        </div>
        ...
        <div v-if="instance" class="message-item">
            ...
            <table class="tai-table tai-table-border">
                ...
                <tr>
                    <td>配置</td>
                    <td>{{ instance.conf ? instance.conf : '--' }}</td>
                </tr>
            </table>
        </div>
        <div v-if="instance" class="message-item">
