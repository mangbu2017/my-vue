...
export default class Overview extends Vue {
    ...
    handleUpdateModalOk(name) {
        this.updateInstance({
            instanceID: this.instance.echinusInstance.instanceID,
            name,
        });
    }
    ...
    fetchInstance(payload) {
        this.loading = true;
        request({
            url: '/echinusBack/instance/detail',
            params: {
            ...
            if (data.resultBean) {
                ...
                this.instance.echinusInstance = data.resultBean.baseBean;
            }
            this.loading = false;
        }).catch((error) => {
            this.loading = false;
    ...
    updateInstance(payload) {
        ...
        request({
            ...
            this.instance.echinusInstance.instanceName = payload.name;
        }).catch((error) => {
