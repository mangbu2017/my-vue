...
export default class Index extends Vue {
    ...
    handleCreateSuccess() {
        ...
        const regUrl = `/spray-alga/detail/${this.$route.params.id}/account`;
    ...
    handlePageChange(page) {
        ...
        this.$router.push(`/spray-alga/detail/${this.$route.params.id}/account/${page}/${this.keyword}`);
    }
    ...
    handleSearch() {
        this.$router.push(`/spray-alga/detail/${this.$route.params.id}/account/1/${this.keyword}`);
    }
    ...
    fetchInstanceListByPage(preventLoadingTip = false) {
        ...
        request({
            url: '/mysqlclientBack/accountmgr/searchAccountList',
            params: payload,
        }).then((data) => {
            this.loading = false;
    ...
    deleteInstanceList(payload) {
        request({
            method: 'POST',
            url: '/mysqlclientBack/accountmgr/deleteDbAccount',
            headers: {
    ...
    submitAuthData(payload) {
        ...
        request({
            method: 'POST',
            url: '/mysqlclientBack/accountmgr/modifyAuthority',
            data: qs.stringify({
                instanceID: this.$route.params.id,
    ...
    fetchDbList(payload) {
        request({
            url: '/mysqlclientBack/accountmgr/searchDatabaseList',
            params: {
                instanceID: this.$route.params.id,
